...
public enum EquipmentRequirement
{
	...
	SALVE_MELEE(new EquipmentInventorySlot[] {AMULET}, new int[][] {{SALVE_AMULET, SALVE_AMULETI, SALVE_AMULETI_25250, SALVE_AMULETI_26763, SALVE_AMULET_E, SALVE_AMULETEI, SALVE_AMULETEI_25278, SALVE_AMULETEI_26782}}),
	SALVE_MAGE_RANGED(new EquipmentInventorySlot[] {AMULET}, new int[][] {{SALVE_AMULETI, SALVE_AMULETI_25250, SALVE_AMULETI_26763, SALVE_AMULETEI, SALVE_AMULETEI_25278, SALVE_AMULETI_26763}}),
	SALVE_ENHANCED(new EquipmentInventorySlot[] {AMULET}, new int[][] {{SALVE_AMULET_E, SALVE_AMULETEI, SALVE_AMULETEI_25278, SALVE_AMULETEI_26782}}),
